                ...
                <div className="col-xs-12">
                    ...
                    <div className="flex-space no-flex-sm">
                      ...
                      <div className="right">
                        <div className="flex no-flex-xs group-btn">
                          <a href="javascript:0" className="btn btn-line">Reagendar Consulta</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="box-dados-group">
                    <div className="flex-space no-flex-md">
                        ...
                        <div className="box-dados">
                          <div className="flex-top">
                            ...
                            <div className="desc">
                              ...
                              <a href="javascript:0" className="btn btn-2 icon"><i className="fa fa-paperclip" />Ver resultados de exames</a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="right">
                        <div className="flex no-flex-xs group-btn">
                          <a href="javascript:0" className="btn btn-line icon"><i className="fa fa-plus" />Salvar e Adicionar</a>
                          <a href="javascript:0" className="btn icon"><i className="fa fa-plus" />Adicionar Prescrição</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="box-btn-footer">
                    <a href="javascript:0" className="btn btn-large icon"><i className="fa fa-check" />Finalizar consulta</a>
                    <a href="javascript:0" className="btn btn-large icon"><i className="fa fa-print" />Finalizar e imprimir</a>
                  </div>
                </div>
              </div>
            </div>
