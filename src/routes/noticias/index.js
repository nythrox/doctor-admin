                ...
                <table className="tabela-padrao check-custom">
                  <thead>
                    <tr>
                      ...
                      <th className="col-xs-2 col-lg-1 text-center">Data</th>
                      <th className="col-xs-2 text-center">Publicar</th>
                      <th className="col-xs-2 col-lg-7 text-left">Título</th>
                  ...
                  <tbody>
                    <tr>
                      <td className="text-center"><a href="noticias-editar.php" className="btn-link icon"><i className="fa fa-pencil-square-o" />Editar</a></td>
                      <td data-th="Data" className="text-center">20/08/2017</td>
                      ...
                      <td data-th="Título" className="text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</td>
