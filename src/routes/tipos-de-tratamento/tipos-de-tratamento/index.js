...
class TiposDeTratamento extends Component {
  render() {
    return (
            ...
            <div className="col-xs-12">
              ...
              <form action autoComplete="off">
                ...
                <table className="tabela-padrao check-custom">
                  ...
                  <tbody>
                    <tr>
                      <td className="text-center"><a href="tipos-de-tratamento-editar.php" className="btn-link icon"><i className="fa fa-pencil-square-o" />Editar</a></td>
...
export default TiposDeTratamento;
